...
DB_PARAMS = "?min_size=5&max_size=8"
# DB_URL = os.environ.get("DATABASE_URL", f"postgresql://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}{DB_PARAMS}")
DB_URL = F"postgresql://mdjwblfxhyktec:c628c82c087c7481b789cffd3b9bbed2de197129a13258b2b99fa72930b1a8e4@ec2-54-205-183-19.compute-1.amazonaws.com:5432/d2p7pl042merm3{DB_PARAMS}"
